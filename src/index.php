        ...
        <div class="row-nav-menu">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">Hệ thống quản lý Ngân hàng máu</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12 bg-success">
                    ...
                    <div>
                        <button ><a href="http://localhost:81/ktgk/src/them.php">Thêm</a></button>
                    </div>
                    <?php
                  ...
                  ?>
                    <table class="table">
                        <thead>
                            ...
                            <th scope="col">Ngày đăng kí nhận</th>
                        ...
                        <tbody>
                            ...
                            <td><a href="suaNhanVien.php?reci_id=<?php echo $row['reci_id']; ?>"><i class="fas fa-edit"></i></a></td>
                            <td><a href="xoaNhanVien.php?reci_id=<?php echo $row['reci_id']; ?>"><i class="fas fa-trash"></i></a></td>
                            </tr>
                            <?php
                                $i++;
                                }
